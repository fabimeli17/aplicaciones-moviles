...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng upc = new LatLng(-12.087336, -77.049885);
        mMap.addMarker(new MarkerOptions().position(upc).title("Marker in Sydney"));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(upc,15F));

        LatLng sydney = new LatLng(-12.085728, -77.050181);
