...
public class LocalesDAO {
    ...
    public LocalesDAO(Context c) {
        _dbHelper = new DbHelper(c);
    }

    public void insertar(Integer codigo, String descripcion, Double latitud, Double longitud, String telefono) throws DAOException {
        Log.i("LocalesDAO", "insertar()");
        SQLiteDatabase db = _dbHelper.getWritableDatabase();
        try {
            Object[] args = new Object[]{codigo, descripcion, latitud, longitud, telefono, "Activo"};
            db.execSQL("INSERT INTO locales(codigo, descripcion, latitud, longitud, telefono, estado) VALUES(?,?,?,?,?,?)", args);
            Log.i("LocalesDAO", "Se insertó");
        } catch (Exception e) {
            throw new DAOException("LocalesDAO: Error al insertar: " + e.getMessage());
        } finally {
            if (db != null) {
                db.close();
            }
